...
public class LottoMadness extends JFrame {
    ...
    JLabel winnersLabel = new JLabel("Winning numbers: ", JLabel.RIGHT);
    ...
    public LottoMadness() {
        ...
        quickpick.addItemListener(lotto.item);
        personal.addItemListener(lotto.item);
        stop.addActionListener(lotto.act);
        play.addActionListener(lotto.act);
        reset.addActionListener(lotto.act);
