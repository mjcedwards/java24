...
public class PointTester {
    public static void main(String[] args) {
        ...
        System.out.println("The 2D point is now at (" + location1.x + ", " + 
                location1.y + ")");
        System.out.println("It is being moved -10 units in both the x and y axes");
        ...
        System.out.println("It is now located at (" + location2.x + ", " +
                location2.y + ", " + location2.z + ")");
        System.out.println("It's being moved -20 units along all axes");
